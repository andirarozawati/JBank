...
public class CustomerGUI extends JFrame implements Runnable, ActionListener, MouseMotionListener, ListSelectionListener
{
    ...
    private void makeFirstPanel()
    {
        ...
        //custIDField.addFocusListener(new CustomerFocusListener(custIDField,"Cust ID",this) );
        ...
        //lastNameField.addFocusListener(new CustomerFocusListener(lastNameField,"Last Name",this) );
     ...
     private void makeSecondPanel()
    {
       ...
       // firstNameField.addFocusListener(new CustomerFocusListener(firstNameField,"First Name",this) );
         
        addressField = new JTextField("Address");
        addressField.setName("Address");
        addressField.setToolTipText("Address");
        addressField.setColumns(30);
       // addressField.addFocusListener(new CustomerFocusListener(addressField , "Address",this) );
     ...
     private void makeThirdPanel()
    {
       ...
       // cityField.addFocusListener(new CustomerFocusListener(cityField , "City",this) );
         
        stateField = new JTextField("State");
        stateField.setName("State");
        stateField.setToolTipText("State");
        stateField.setColumns(10);
       // stateField.addFocusListener(new CustomerFocusListener(stateField , "State",this) );
         
        zipField = new JTextField("Zip Code");
        zipField.setName("Zip Code");
        zipField.setToolTipText("Zip Code");
        zipField.setColumns(15);
       // zipField.addFocusListener(new CustomerFocusListener(zipField, "Zip Code",this) );
        
        phoneField = new JTextField("Phone");
        phoneField.setName("Phone");
        phoneField.setToolTipText("Phone");
        phoneField.setColumns(25);
       // phoneField.addFocusListener(new CustomerFocusListener(phoneField , "Phone",this) );
    ...
    private void makeFourthPanel()
    {
       ...
       // emailField.addFocusListener(new CustomerFocusListener(emailField, "Email Address",this) );
       ...
       // dobField.addFocusListener(new CustomerFocusListener(dobField,"DOB - yyyy/mm/dd",this) );
    ...
    private void makeAccountPanel()
    {
       ...
       // amountField.addFocusListener(new CustomerFocusListener(amountField,"Enter Amount",this));
        
        termField   = new JTextField();
        termField.setColumns(10);
        termField.setText("Invest Term");
        termField.setName("Invest Term");
       // termField.addFocusListener(new CustomerFocusListener(termField,"Invest Term",this));
       ...
       // creditLimitField.addFocusListener(new CustomerFocusListener(creditLimitField,"Credit Limit",this));
    ...
    */
   private Customer updateDataCustomer() throws CustomerNotFoundException
   {
       int custID =  0;
       try{
   ...
   private Customer buatCustomerBaru()
   {
       ...
       catch(MaxNumOfCustomersException mcr)
       {
